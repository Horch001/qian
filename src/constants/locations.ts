...
export const LOCATION_DATA: Country[] = [
  {
    name: '中国',
    regions: [
      { name: '北京', cities: ['北京市', '朝阳区', '海淀区', '丰台区', '西城区'] },
      { name: '上海', cities: ['上海市', '浦东新区', '黄浦区', '徐汇区', '静安区'] },
      { name: '天津', cities: ['天津市', '滨海新区', '和平区', '南开区'] },
      { name: '重庆', cities: ['重庆市', '渝中区', '江北区', '沙坪坝区', '万州区'] },
