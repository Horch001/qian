...
export const OfflinePlaYPage: React.FC = () => {
  ...
  useEffect(() => {
    const cacheKey = `offline_${selectedProvince}_${selectedCity}_${searchText}`;
              ...
              <div className="flex gap-2 relative">
                ...
                <div className="flex-1 min-w-0 flex flex-col justify-between h-14 pr-20">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-red-600 font-bold text-base leading-none">{Number(product.price).toFixed(2)}π/h</span>
                    <div className="flex gap-2">
                  ...
                  <div className="text-[10px] text-gray-400 leading-none">
                    {product.merchant?.shopName || '陪玩服务'}
                  </div>
                </div>
